...
class Locales {
  ...
  static const id = {
    'ask_existing_page':
    'Halaman [%s] sudah ada, apakah Anda ingin menimpanya?',
    'ask_name_to_project': 'Apa nama proyeknya?',
    'ask_company_domain': 'Apa domain perusahaan Anda?',
    'ask_model_name':
    'Tidak dapat mengatur nama model secara otomatis, nama apa yang ingin Anda gunakan?',
    'ask_package_already_installed':
    'Paket: %s sudah terinstal, apakah Anda ingin memperbaruinya?',
    'ask_lib_not_empty':
    'Folder lib Anda tidak kosong. Apakah Anda yakin ingin menimpa aplikasi Anda? \n PERINGATAN: Tindakan ini tidak dapat dibatalkan',
    'ask_ios_lang': 'Bahasa apa yang ingin Anda gunakan di iOS?',
    'ask_android_lang': 'Bahasa apa yang ingin Anda gunakan di Android?',
    'ask_use_null_safe': 'Apakah Anda ingin menggunakan null safety?',
    'ask_use_linter': 'Apakah Anda ingin menggunakan linter?',
    'ask_new_page_name': 'Apa nama baru untuk halaman?',
    'error_failed_to_connect': 'Gagal terhubung dengan %s.',
    'error_no_valid_file_or_url': '%s bukan file atau URL yang valid.',
    'error_unnecessary_parameter': 'Parameter %s tidak diperlukan.',
    'error_unnecessary_parameter_plural': 'Parameter %s tidak diperlukan.',
    'error_nonexistent_directory': 'Direktori %s tidak ada.',
    'error_empty_directory': '%s kosong.',
    'error_invalid_json': '%s bukan file JSON yang valid.',
    'error_special_characters_in_key':
    'Karakter khusus tidak diperbolehkan dalam kunci. \n Kunci: %s',
    'error_required_path': 'Diperlukan jalur file atau direktori.',
    'error_invalid_dart': '%s bukan file Dart yang valid.',
    'error_invalid_file_or_directory': '%s bukan file atau direktori yang valid.',
    ...
    'error_unexpected': 'Terjadi kesalahan yang tidak terduga:',
    'error_no_package_to_remove':
    'Masukkan nama paket yang ingin Anda hapus.',
    'example': 'Contoh:',
    'warning': 'Peringatan:',
    'hint_create_controller': 'Buat controller',
    'hint_create_page': 'Gunakan untuk membuat halaman',
    'hint_create_project': 'Gunakan untuk membuat proyek baru',
    'hint_create_provider': 'Buat Provider baru',
    'hint_create_screen': 'Buat layar baru',
    'hint_create_view': 'Buat view',
    'hint_generate_locales': 'Buat file terjemahan dari file JSON',
    'hint_generate_model': 'Buat model kelas dari JSON',
    'hint_help': 'Tampilkan bantuan ini',
    'hint_init': 'Buat struktur yang dipilih dalam proyek yang sudah ada:',
    ...
    'info_update_available2': 'Versi baru tersedia: %s. Silakan jalankan:',
    'options_yes': 'Ya!',
    'options_no': 'Tidak',
    'options_rename': 'Saya ingin mengganti nama',
    'optional_parameters': 'Parameter opsional: %s',
    'sucess_page_create': 'Halaman %s berhasil dibuat.',
    'sucess_locale_generate': 'File lokal berhasil dibuat.',
    'sucess_getx_pattern_generated':
    'Struktur GetX Pattern berhasil dibuat.',
    'sucess_clean_Pattern_generated':
    'Struktur CLEAN Pattern berhasil dibuat.',
    'sucess_file_formatted': ' \'%s\' berhasil diformat',
    'sucess_package_removed': 'Paket: %s berhasil dihapus!',
    'sucess_package_installed': 'Paket: %s berhasil diinstal!',
    'sucess_update_cli': 'Pembaruan selesai',
    'sucess_add_controller_in_bindings':
    '%s telah ditambahkan ke binding di jalur: %s',
    'sucess_navigation_added': 'Navigasi %s berhasil ditambahkan.',
    'sucess_file_created': 'File: %s berhasil dibuat di jalur: %s',
    'sucess_route_created': 'Rute %s berhasil dibuat.',
  };
}
